   ...
   - **d. Phép tích chập (Convolution)**
        - Công thức
           ...
           Mô phỏng công thức:
            ...
            Hàm **f(m)** đại diện là ô vuông màu xanh và Hàm **g(t-x)** đại diện cho ô vuông màu đỏ. Tích chập **(f*g)[n]** thể hiện mức độ giao hoán của hai hàm **f(m)** và **g(n-m)** tại ví trí n.
